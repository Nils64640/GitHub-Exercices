...
typea calculVis(					//retourne la masse d'acier pour 1000 vis de chaque
	typeb diametre,					//diamètre vis choisi par l'utilisateur
	typeb longueur1,				//1ere longueur de vis
	typeb longueur2,				//2eme longueur de vis
	typeb longueur3,				//3eme longueur de vis
	typec& masseVisLongueur1,		//masse d'une vis  de longueur1
	typec& masseVisLongueur2,		//masse d'une vis  de longueur2
	typec& masseVisLongueur3		//masse d'une vis  de longueur3
);
